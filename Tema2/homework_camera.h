...
//Class for the camera from the labs
namespace Camera
{
    class Camera
    {
     public:
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            right = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.f), angle, forward) * glm::vec4(right, 1)));
            forward = glm::normalize(glm::vec3(glm::rotate(glm::mat4(1.f), angle, forward) * glm::vec4(up, 1)));
            up = glm::cross(right, forward);
        }
